...
activity_data = [
  {
    ...
    type: 'THEORETICAL',
    unity_id: nil,
    bloom_data: ['RECORDAR', 'COMPRENDER', 'APLICAR', 'EVALUAR']
  },
  {
    module_name: 'Semiología Médica',
    ...
    type: 'THEORETICAL',
    unity_id: nil,
    bloom_data: ['COMPRENDER', 'APLICAR', 'ANALIZAR', 'EVALUAR']
  },
  {
    module_name: 'Semiología Médica',
  ...
  },
  {
    ...
    type: 'PRACTICAL',
    unity_id: nil,
    bloom_data: ['APLICAR', 'ANALIZAR', 'EVALUAR', 'CREAR']
  },
  {
  ...
  },
  {
    ...
    type: 'THEORETICAL',
    unity_id: nil,
    bloom_data: ['COMPRENDER', 'APLICAR', 'ANALIZAR', 'CREAR']
  },
  {
    ...
    type: 'THEORETICAL',
    unity_id: nil,
    bloom_data: ['RECORDAR', 'COMPRENDER', 'APLICAR', 'ANALIZAR']
  },
  {
    module_name: 'Semiología Neurológica',
...
activity_data = [
  {
    ...
    type: 'PRACTICAL',
    bloom_data: ['APLICAR', 'ANALIZAR', 'COMPRENDER', 'EVALUAR']
  },
  {
    module_name: 'Semiología Médica',
    name: 'Realizar un examen práctico de diagnóstico en pacientes simulados',
    type: 'PRACTICAL',
    bloom_data: ['APLICAR', 'CREAR', 'EVALUAR', 'ANALIZAR']
  },
  {
    module_name: 'Semiología Médica',
    name: 'Evaluar pacientes con trastornos médicos diversos',
    type: 'THEORETICAL',
    bloom_data: ['EVALUAR', 'ANALIZAR', 'CREAR', 'COMPRENDER']
  },
  {
    module_name: 'Semiología Médica',
    name: 'Presentar casos clínicos y diagnósticos a los compañeros',
    type: 'THEORETICAL',
    bloom_data: ['CREAR', 'ANALIZAR', 'COMPRENDER', 'EVALUAR']
  },
  {
    module_name: 'Semiología Oftalmológica',
    name: 'Realizar un examen detallado del segmento anterior del ojo',
    type: 'PRACTICAL',
    bloom_data: ['APLICAR', 'COMPRENDER', 'ANALIZAR', 'CREAR']
  },
  {
    module_name: 'Semiología Oftalmológica',
    name: 'Interpretar resultados de pruebas oftalmológicas',
    type: 'THEORETICAL',
    bloom_data: ['ANALIZAR', 'COMPRENDER', 'EVALUAR', 'CREAR']
  },
  {
    module_name: 'Semiología Oftalmológica',
    name: 'Realizar un examen práctico de oftalmoscopía',
    type: 'PRACTICAL',
    bloom_data: ['APLICAR', 'CREAR', 'ANALIZAR', 'COMPRENDER']
  },
  {
    module_name: 'Semiología Oftalmológica',
    name: 'Comparar diferentes enfermedades oftalmológicas',
    type: 'THEORETICAL',
    bloom_data: ['ANALIZAR', 'CREAR', 'COMPRENDER', 'EVALUAR']
  },
  {
    module_name: 'Semiología Radiológica',
    name: 'Interpretar radiografías y detectar anomalías',
    type: 'THEORETICAL',
    bloom_data: ['ANALIZAR', 'EVALUAR', 'CREAR', 'COMPRENDER']
  },
  {
    module_name: 'Semiología Radiológica',
    name: 'Evaluar la calidad de las imágenes radiológicas',
    type: 'THEORETICAL',
    bloom_data: ['EVALUAR', 'CREAR', 'ANALIZAR', 'COMPRENDER']
  },
  {
    module_name: 'Semiología Radiológica',
    name: 'Redactar informes radiológicos para casos específicos proporcionados',
    type: 'PRACTICAL',
    bloom_data: ['CREAR', 'APLICAR', 'EVALUAR', 'COMPRENDER']
  },
  {
    module_name: 'Semiología Radiológica',
    name: 'Presentar estudios de casos de radiología a los compañeros',
    type: 'THEORETICAL',
    bloom_data: ['CREAR', 'APLICAR', 'ANALIZAR', 'COMPRENDER']
  },
  {
    module_name: 'Semiología Neurológica',
    name: 'Evaluar pacientes con trastornos neurológicos basados en historias clínicas y pruebas',
    type: 'THEORETICAL',
    bloom_data: ['EVALUAR', 'ANALIZAR', 'COMPRENDER', 'CREAR']
  },
  {
    module_name: 'Semiología Neurológica',
    name: 'Comparar y contrastar diferentes pruebas neurológicas',
    type: 'THEORETICAL',
    bloom_data: ['ANALIZAR', 'COMPRENDER', 'CREAR', 'EVALUAR']
  },
  {
    module_name: 'Semiología Neurológica',
    name: 'Preparar y presentar casos neurológicos con hallazgos y diagnósticos',
    type: 'PRACTICAL',
    bloom_data: ['CREAR', 'APLICAR', 'ANALIZAR', 'EVALUAR']
  },
  {
    module_name: 'Semiología Cardiovascular',
    name: 'Realizar una exploración física cardiológica completa y documentar los hallazgos',
    type: 'PRACTICAL',
    bloom_data: ['APLICAR', 'COMPRENDER', 'ANALIZAR', 'EVALUAR']
  },
  {
    module_name: 'Semiología Cardiovascular',
    name: 'Evaluar pacientes con enfermedades cardíacas mediante pruebas diagnósticas',
  ...
  },
  {
    ...
    name: 'Identificar trastornos gastrointestinales en pacientes virtuales y proponer diagnósticos',
    type: 'THEORETICAL',
    bloom_data: ['COMPRENDER', 'ANALIZAR', 'EVALUAR', 'CREAR']
  },
  {
    module_name: 'Semiología Gastrointestinal',
    name: 'Interpretar resultados de endoscopias y explicar las observaciones clínicas',
  ...
  },
  {
    ...
    name: 'Evaluar pacientes con enfermedades gastrointestinales y justificar el enfoque diagnóstico',
    type: 'THEORETICAL',
    bloom_data: ['EVALUAR', 'COMPRENDER', 'ANALIZAR', 'CREAR']
  },
  {
    module_name: 'Semiología Respiratoria',
    name: 'Evaluar pacientes con enfermedades respiratorias crónicas, recomendando tratamientos',
  ...
  },
  {
    ...
    name: 'Realizar pruebas de función pulmonar y analizar los resultados',
    type: 'THEORETICAL',
    bloom_data: ['APLICAR', 'ANALIZAR', 'EVALUAR', 'COMPRENDER']
  },
  {
    module_name: 'Semiología Respiratoria',
    name: 'Interpretar radiografías torácicas y describir las anomalías observadas',
    type: 'THEORETICAL',
    bloom_data: ['ANALIZAR', 'EVALUAR', 'COMPRENDER', 'CREAR']
  },
  {
    module_name: 'Semiología Otorrinolaringológica',
    name: 'Realizar un examen detallado de oído, nariz y garganta en pacientes virtuales',
  ...
  },
  {
    ...
    name: 'Diagnosticar enfermedades otorrinolaringológicas basadas en historias clínicas y pruebas',
    type: 'PRACTICAL',
    bloom_data: ['EVALUAR', 'CREAR', 'APLICAR', 'ANALIZAR']
  }
]
...
modules_and_activities = [
  {
    ...
    activities: [
      ...
      },
      {
        ...
        activity_type: "PRACTICAL",
        bloom_levels: ["APLICAR", "ANALIZAR", "EVALUAR"]
      }
    ]
  },
  {
...
def calificate_student(student_id)
  bloom_level_comments_semiologia = {
    "RECORDAR" => "Tu capacidad para recordar información es adecuada, pero sería beneficioso profundizar en la comprensión de los conceptos.",
    "COMPRENDER" => "Comprendes bien los conceptos de Semiología, pero podrías explorar más a fondo las relaciones entre ellos.",
    "APLICAR" => "Has aplicado tus conocimientos de Semiología de manera efectiva en estas actividades. Sigue así.",
    "ANALIZAR" => "Tu habilidad para analizar situaciones y datos relacionados con Semiología es impresionante. Continúa profundizando en tu análisis.",
    "EVALUAR" => "Has demostrado un alto nivel de evaluación y juicio crítico en el contexto de Semiología. Excelente trabajo.",
    "CREAR" => "Tu capacidad para aplicar la creatividad y la innovación en el contexto de Semiología es sobresaliente. Sigue generando ideas nuevas."
  }
  ...
  activity_califications.each do |activity_calification|
    next if activity_calification.unity.academic_period.number == 3
    ...
    bloom_levels.each do |bloom_level|
      ...
      comment = bloom_level_comments_semiologia[bloom_level.verb] || "Gran trabajo"
      bloom_level.update(comment: comment)
    end
...
def create_semiologia_rotation
  ...
  #calificate_student(student_id)
end

create_semiologia_rotation
